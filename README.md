...
catkin_make
```
You might face a build error on Ubuntu 18.04 LTS with ROS Melodic. This happens due to a conflict of ```/usr/include/lz4.h``` with ```/usr/include/flann/ext/lz4.h```. To fix it run
